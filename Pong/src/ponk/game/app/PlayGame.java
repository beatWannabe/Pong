...
import ponk.game.pojo.PongBall;
import ponk.game.pojo.PongBar;
...
public class PlayGame extends JPanel {
    ...
    private final PongBall ponkBall = new PongBall(this);
    public final PongBar bar = new PongBar(this);
    ...
    public static void main(String[] args) throws InterruptedException {
        JFrame principalFrame = new JFrame("PONG!");
    ...
    public void gameOver() throws InterruptedException {
        ...
        if (JOptionPane.showConfirmDialog(this, "Puntuacion " + ScoreStatus.getPlayerActualScore() + " \n Desea Continuar ?", "Game Over", 0) == 0) {
            ponkBall.setEjeX(0);
            ponkBall.setEjeY(0);
            PongBall.setAumentoVelocidad(1);
            ScoreStatus.setPlayerActualScore(0);
            //----->
            PongBar.setNivelAvanceBar(2);
            bar.setEjeX(screenDimension(super.getWidth(), PongBar.getWith()));
            ponkBall.move();
        } else {
            System.exit(ABORT);
        }
